...
将 `squirrel.custom.yaml` 复制到：

```text
~/Library/Rime/
```

然后点击菜单栏鼠须管图标，选择 **重新部署（Redeploy）** 即可生效。

## 🖼️ 效果预览

### 浅色模式

<img width="336" height="83" alt="Light" src="https://github.com/user-attachments/assets/ffb1d099-d4c4-48db-b169-44c309d68d0c" />

### 深色模式

<img width="358" height="86" alt="Dark" src="https://github.com/user-attachments/assets/e2a9a306-d6fb-43a6-a439-3899fd03a029" />

## 🙏 致谢

本项目基于 **安静（qvshuo）** 的 macOS 主题进行修改。

在原主题基础上，对颜色、圆角、间距、字体等细节进行了重新调整，力求更接近 **macOS 27 原生输入法**的视觉风格。
...
2. Replace it with your existing configuration.
